                        ...
                        {this.props.results.map((res,i) => {
                            ...
                            return (
                                <View key={i} style={{flex:1, flexDirection: 'row', backgroundColor: background}}>
                                    <View style={{flex:1}}>
                                        <Text style={{fontSize: Style.Font.large(),textAlign: 'center', color:text}}>{res.odds}</Text>
                                    </View>
                                    <View style={{flex:1}}>
                                        <Text style={{fontSize: Style.Font.large(),textAlign: 'center', color:text}}>{res.result}</Text>
                                    </View>
                                </View>
                            );
                        })}
