        ...
        return (
            <View style={{flex:3, alignItems:'center'}}>
                <View style={{flex:1,alignSelf: 'stretch'}}>
                    <Text style={{fontSize: Font.smallmedium(),fontWeight: 'bold',backgroundColor: 'silver', textAlign: 'center'}}>Leader Loss</Text>
                </View>            
                <View style={{flex:5, flexDirection:'row', justifyContent:'center', alignItems: 'center'}}>            
                    <View style={{flex:3, alignItems:'center'}}>
                        <Text style={{fontSize: Font.medium(),textAlign: 'center'}}>{loss}</Text>
                    </View>
