...
var ScrollingTabBar = require('./views/scrollingTabBar');
  ...
  render() {
    return (
      <View style={{flexDirection: 'column'}}>
        ...
        <Text style={{fontWeight: 'bold', xtextAlign: 'center'}}>{this.props.data.name}</Text>
      </View>
    );
  }
});
...
AppRegistry.registerComponent('lb', () => RugbyExample);
