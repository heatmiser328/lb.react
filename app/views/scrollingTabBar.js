...
var DefaultTabBar = React.createClass({
  ...
  renderTabOption(name, page, numtabs) {
    var isTabActive = this.props.activeTab === page;
    var width = deviceWidth / numtabs;

    return (
      <TouchableOpacity key={name} onPress={() => this.props.goToPage(page)}>
        <View style={[styles.tab, {width: width}]}>
  ...
  render() {
    ...
    return (
      <View style={styles.tabs}>
        {this.props.tabs.map((tab, i) => this.renderTabOption(tab, i, numberOfTabs))}
